    ...
    function getProducts(){
        ...
        <div class='card' >
            ...
            <div class='card-body'>
                ...
                <a href='project.php?add_to_cart=$product_id' class='btn btn-info d-flex justify-content-center'>Add to cart</a>
    ...
    if(isset($_GET['category'])){
        ...
        <div class='card' >
            ...
            <div class='card-body'>
                ...
                <p class='card-text'> $product_description</p>
                <p class='card-text'> $product_price</p>
                <a href='project.php?add_to_cart=$product_id' class='btn btn-info'>Add to cart</a>
...
<div class='card' >
    ...
    function getBrands(){
       ...
       while($row_data=mysqli_fetch_assoc($result_brands)){
           ...
           <a href='project.php?brand=$brand_id' class='nav-link text-light text-center'>$brand_title</a>
       </li>";
       }
    }
    ...
    function getCategories(){
       ...
       while($row_data=mysqli_fetch_assoc($result_categories)){
           ...
           echo "<li class='nav-item'>
           <a href='project.php?category=$category_id' class='nav-link text-light text-center'> $category_title</a>
       </li>";
       }
    }
